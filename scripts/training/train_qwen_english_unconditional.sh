...
echo "Training Unconditional (unconditional) model"
...
# Run training with l2t mode - Using your new parameters
if [ ${WORLD_SIZE} -gt 1 ]; then
    ...
    torchrun \
      ...
      logging.run_name="mmdit-qwen-32d-unconditional" \
    ...
    # Single-node - Using your new parameters
    torchrun \
      --nnodes=1 \
      --nproc_per_node=8 \
      latentDLM_mmdit/train_mmdit.py \
